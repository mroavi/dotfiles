...
theme.hotkeys_modifiers_fg = "#999999"
...
theme.wallpaper = os.getenv("HOME").."/Pictures/zelda2.jpg"
...
-- vim: filetype=lua:expandtab:shiftwidth=4:tabstop=8:softtabstop=4:textwidth=78
